Shader "Test/CustomHologramTestShader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        CGPROGRAM
        #pragma surface surf CustomBlinnPhong alpha:fade
        #pragma target 4.0
        ...
        void surf(Input IN, inout SurfaceOutput o)
        {
            ...
            fixed4 noiseTex = tex2D(_noiseTex, float2(IN.uv_noiseTex.x + _Time.x * 3, IN.uv_noiseTex.y + _Time.x * 3));

            o.Normal = nor1;
            //o.Emission = baseTex.rgb;
            o.Emission = baseTex.rgb * noiseTex.rgb;
            o.Gloss = _gloss;
            o.Alpha = baseTex.a;
        }
